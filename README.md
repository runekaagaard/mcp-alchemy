...
```json
{
  "mcpServers": {
    "my_sqlite_db": {
      "command": "uvx",
      "args": ["--from", "mcp-alchemy==2025.04.08.213054", "mcp-alchemy"],
      "env": {
...
```json
{
  "mcpServers": {
    "my_postgres_db": {
      "command": "uvx",
      "args": ["--from", "mcp-alchemy==2025.04.08.213054", "--with", "psycopg2-binary", "mcp-alchemy"],
      "env": {
...
```json
{
  "mcpServers": {
    "my_mysql_db": {
      "command": "uvx",
      "args": ["--from", "mcp-alchemy==2025.04.08.213054", "--with", "pymysql", "mcp-alchemy"],
      "env": {
...
```json
{
  "mcpServers": {
    "my_mssql_db": {
      "command": "uvx",
      "args": ["--from", "mcp-alchemy==2025.04.08.213054", "--with", "pymssql", "mcp-alchemy"],
      "env": {
...
```json
{
  "mcpServers": {
    "my_oracle_db": {
      "command": "uvx",
      "args": ["--from", "mcp-alchemy==2025.04.08.213054", "--with", "cx_oracle", "mcp-alchemy"],
      "env": {
